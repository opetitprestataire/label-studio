      ...
      >
        ...
        <div className={cn(
          ...
          <div className="flex-grow">
            <Label htmlFor="aws" className="font-medium text-base cursor-pointer">AWS S3</Label>
        ...
        <div className={cn(
          ...
          <div className="flex-grow">
            <Label htmlFor="gcp" className="font-medium text-base cursor-pointer">Google Cloud Storage</Label>
        ...
        <div className={cn(
          ...
          <div className="flex-grow">
            <Label htmlFor="azure" className="font-medium text-base cursor-pointer">Azure Blob Storage</Label>
