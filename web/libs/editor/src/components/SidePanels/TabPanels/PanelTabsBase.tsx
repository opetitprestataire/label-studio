  ...
  return (
    <Block ref={panelRef} name="tabs-panel" mod={mods} style={{ ...style, ...coordinates }}>
      {isBottomPanel && collapsibleBottomPanel && !bottomCollapsed && (
        <div
          className="w-full h-tight absolute -top-tight left-none cursor-row-resize bg-neutral-emphasis hover:bg-primary-border active:bg-primary-border transition-colors duration-100 select-none z-10"
