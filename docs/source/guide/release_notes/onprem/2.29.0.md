...
![Screenshot](/images/releases/2_29_adjust.png)
...
![Screenshot](/images/releases/2-29-azure.png)
...
![Screenshot](/images/releases/2-29-cloud-storage-modal.png)

#### Debug custom agreement metrics

There is a new **See Logs** option for custom agreement metrics [LINK], which you can use to view log history and error messages.

![Screenshot](/images/releases/2-29-debug-metrics.png)
...
![Screenshot](/images/releases/2-29-dm-columns.png)
...
![Screenshot](/images/releases/2-29-multilabels.mp4)
