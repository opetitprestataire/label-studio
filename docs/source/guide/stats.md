...
- a per-task selectable agreement score, visible on the Data Manager page for a project. This allows you to select annotators, models, and ground truth to include in the calculation. [Agreement Column](manage_data#Agreement-Selected)
