...
from .models import UserProductTour, ProductTourInteractionData
...
class UserProductTourSerializer(serializers.ModelSerializer):
    ...
    def validate_name(self, value):
        ...
        if value not in self.available_tours:
            raise serializers.ValidationError(f'Product tour {value} not found. Available tours: {self.available_tours}')
