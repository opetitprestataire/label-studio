...
def custom_project_setup(request):
    """Custom project setup landing page"""
    from django.shortcuts import render
    return render(request, 'core/custom_setup.html', {'title': 'Project Setup'})
